...
@section('content')
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Manajemen Pasca-Rental (Mobil Kembali)</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item ">Rental</li>
                    <li class="breadcrumb-item active">Pasca Rental</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <form class="row g-3" method="POST" action="{{ route('rental.update', $transaction->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        {{-- Tombol Create --}}
                        <div class="card">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select mb-3 @error('pelanggan_id') is-invalid @enderror"
                                                    ...
                                                    @foreach ($customers as $customer)
                                                        @if ($customer->id === $transaction->pelanggan_id)
                                                            <option value="{{ $customer->id }}" selected>{{ $customer->nama_pelanggan }} -
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select mb-3 @error('pengemudi_id') is-invalid @enderror"
                                                    ...
                                                    @foreach ($drivers as $driver)
                                                        @if ($driver->id === $transaction->pengemudi_id)
                                                            <option value="{{ $driver->id }}" selected>{{ $driver->nama_pengemudi }}</option>
                                                        @endif
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select mb-3 @error('vehicle_id') is-invalid @enderror"
                                                    ...
                                                    @foreach ($vehicles as $vehicle)
                                                        @if ($vehicle->id === $transaction->kendaraan_id)
                                                            <option value="{{ $vehicle->id }}" selected>{{ $vehicle->seri }} - {{ $vehicle->plat_nomor }}</option>
                                                        @endif
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control mb-3 @error('note') is-invalid @enderror" name="note" id="note" rows="5"
                                                    value="{{ old('note') }}">{{ $transaction->note }}</textarea>
                                                @error('note')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="date"
                                                            ...
                                                            name="tanggal_mulai" value="{{ old('tanggal_mulai', $transaction->tanggal_mulai) }}" disabled>
                                                        @error('tanggal_mulai')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="date"
                                                            ...
                                                            name="tanggal_rencana_kembali" value="{{ old('tanggal_rencana_kembali', $transaction->tanggal_rencana_kembali) }}" disabled>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            name="mulai_km" value="{{ old('mulai_km', $transaction->mulai_km) }}" disabled>
                                                        @error('mulai_km')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="bahan_bakar_masuk" class="form-label">BBM</label>
                                                            <select name="bahan_bakar_masuk" id="bahan_bakar_masuk" class="form-select mb-3" disabled>
                                                                @if ($transaction->bahan_bakar_masuk)
                                                                    <option value="{{ $transaction->bahan_bakar_masuk }}" selected>{{ $transaction->bahan_bakar_masuk }}</option>
                                                                @endif
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            name="akhir_km" value="{{ old('akhir_km') }}">
                                                        @error('akhir_km')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <select name="bahan_bakar_habis" id="bahan_bakar_habis" class="form-select mb-3">
                                                            <option value="Fuel">Fuel</option>
                                                            <option value="1/8 F">1/8 F</option>
                                                            <option value="1/4 F">1/4 F</option>
                                                            <option value="3/4 F">3/4 F</option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="file" name="out_foto_depan" id="out_foto_depan" accept="image/*" onchange="previewImage(this, '#out_preview_depan')" disabled>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="file" name="out_foto_belakang" id="out_foto_belakang" accept="image/*" onchange="previewImage(this, '#out_preview_belakang')" disabled>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="file" name="out_foto_kanan" id="out_foto_kanan" accept="image/*" onchange="previewImage(this, '#out_preview_kanan')" disabled>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="file" name="out_foto_kiri" id="out_foto_kiri" accept="image/*" onchange="previewImage(this, '#out_preview_kiri')" disabled>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="file" name="back_foto_depan" id="back_foto_depan" accept="image/*" onchange="previewImage(this, '#back_preview_depan')">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="file" name="back_foto_belakang" id="back_foto_belakang" accept="image/*" onchange="previewImage(this, '#back_preview_belakang')">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="file" name="back_foto_kanan" id="back_foto_kanan" accept="image/*" onchange="previewImage(this, '#back_preview_kanan')">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="file" name="back_foto_kiri" id="back_foto_kiri" accept="image/*" onchange="previewImage(this, '#back_preview_kiri')">
