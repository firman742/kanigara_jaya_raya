                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Multi Columns Form -->
                            <form class="row g-3" method="POST" action="{{ route('pengemudi.store') }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-12">
                                    <label for="nama_pengemudi" class="form-label">Nama</label>
                                    <input type="text" class="form-control @error('nama_pengemudi') is-invalid @enderror" name="nama_pengemudi" value="{{ old('nama_pengemudi') }}">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control @error('lisensi') is-invalid @enderror" name="lisensi" value="{{ old('lisensi') }}">
                                    @error('lisensi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="date" class="form-control @error('masa_berlaku_lisensi') is-invalid @enderror" name="masa_berlaku_lisensi" min="1900" max="2099" step="1" value="{{ old('masa_berlaku_lisensi') }}">
