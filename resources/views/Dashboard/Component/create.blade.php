        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Tambah Data Komponen</h5>

                            <!-- Multi Columns Form -->
                            <form class="row g-3" method="POST" action="{{ route('komponen.store') }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-12">
                                    <label for="nama_komponen" class="form-label">Nama Komponen</label>
                                    <input type="text" class="form-control @error('nama_komponen') is-invalid @enderror" name="nama_komponen" value="{{ old('nama_komponen') }}">
                                    @error('nama_komponen')
