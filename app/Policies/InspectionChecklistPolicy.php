...
class InspectionChecklistPolicy
{
     ...
     */
    public function restore(User $user, InspectionChecklist $inspectionChecklist): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, InspectionChecklist $inspectionChecklist): bool
    {
        return false;
    }
}
